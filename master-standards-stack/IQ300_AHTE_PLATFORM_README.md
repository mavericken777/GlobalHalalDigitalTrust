...
The generated package contains Mermaid process-flow specifications plus SVG architecture, standards-coverage, clause-count and control-pipeline visuals.

## Governance rule

AHTE is a digital trust/evidence and operationalisation layer. It does not replace the competent Halal authority or create certification autonomously. Laboratory results, AI outputs, QR codes, blockchain records, manufacturer declarations and platform events are evidence/operational mechanisms only; authority decisions remain distinct.
