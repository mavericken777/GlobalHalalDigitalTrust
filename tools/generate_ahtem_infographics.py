...
def one_flow(item):
    ...
    p=[f'<svg xmlns="http://www.w3.org/2000/svg" width="{W}" height="{H}" viewBox="0 0 {W} {H}">',
       ...
       txt(1690,110,"Paraphrased implementation view",16,500,"end","#cbd5e1"),
    ...
    p += ['<rect x="82" y="1018" width="500" height="58" rx="15" fill="#ecfeff" stroke="#99f6e4"/>',
          ...
          '<rect x="600" y="1018" width="500" height="58" rx="15" fill="#fefce8" stroke="#fde68a"/>',
          txt(625,1055,"Authority-controlled decision / certification boundary",15,650),
...
def master(items):
    ...
    p += [f'<rect x="{fx}" y="{fy}" width="{3*panel_w+2*gx}" height="{panel_h}" rx="18" fill="#f8fafc" stroke="#cbd5e1"/>',
          ...
          txt(fx+22,fy+101,"Certification boundary",14,800),
          txt(fx+22,fy+127,"Competent authorities and applicable regulators retain certification and authority decisions.",13,550,fill="#334155"),
          txt(fx+22,fy+165,"Analytical boundary",14,800),
          txt(fx+22,fy+191,"Laboratory and AI outputs are evidence/decision-support; they do not independently create Malaysian Halal certification.",13,550,fill="#334155"),
